...
('67', 'Estando contigo', 'Conchita Bautista', '47', '', 'Conchita Bautista represented Spain in 1961 with the song Estando contigo', '6'),
...
('88', 'Llámame', 'Victor Balaguer', '47', '', 'Victor Balaguer represented Spain in 1962 with the song Llámame', '7'),
...
('102', 'Algo prodigioso', 'José Guardiola', '47', '', 'José Guardiola represented Spain in 1963 with the song Algo prodigioso', '8'),
...
('118', 'Caracola', 'Tim, Nelly and Tony', '47', '', 'Tim, Nelly and Tony represented Spain in 1964 with the song Caracola', '9'),
...
('137', 'Qué bueno, qué bueno', 'Conchita Bautista', '47', '', 'Conchita Bautista represented Spain in 1965 with the song Qué bueno, qué bueno', '10'),
...
('148', 'Yo soy aquél', 'Raphael', '47', '', 'Raphael represented Spain in 1966 with the song Yo soy aquél', '11'),
...
('164', 'Hablemos del amor', 'Raphael', '47', '', 'Raphael represented Spain in 1967 with the song Hablemos del amor', '12'),
...
-- Canciones del año 1968
INSERT INTO songs (id, title, artist, country_id, image, information, edition_id) VALUES
('176', 'La, la, la', 'Massiel', '47', '', 'Massiel represented Spain in 1968 with the song La, la, la', '13'),
...
-- Canciones del año 1969
INSERT INTO songs (id, title, artist, country_id, image, information, edition_id) VALUES
('193', 'Vivo cantando', 'Salomé', '47', '', 'Salomé represented Spain in 1969 with the song Vivo cantando', '14'),
...
('214', 'Gwendolyne', 'Julio Iglesias', '47', '', 'Julio Iglesias represented Spain in 1970 with the song Gwendolyne', '15'),
...
-- Canciones del año 1971
INSERT INTO songs (id, title, artist, country_id, image, information, edition_id) VALUES
('221', 'Un banc, un arbre, une rue', 'Séverine', '32', '', 'Séverine represented Monaco in 1971 with the song Un banc, un arbre, une rue', '16'),
('222', 'En un mundo nuevo', 'Karina', '47', '', 'Karina represented Spain in 1971 with the song En un mundo nuevo', '16'),
...
('248', 'Amanece', 'Jaime Morey', '47', '', 'Jaime Morey represented Spain in 1972 with the song Amanece', '17'),
...
-- Canciones del año 1973
INSERT INTO songs (id, title, artist, country_id, image, information, edition_id) VALUES
('257', 'Marie David', 'Anne', '29', '', 'Anne represented Luxembourg in 1973 with the song Marie David', '18'),
('258', 'Eres tú', 'Mocedades', '47', '', 'Mocedades represented Spain in 1973 with the song Eres tú', '18'),
...
('282', 'Canta y sé feliz', 'Peret', '47', '', 'Peret represented Spain in 1974 with the song Canta y sé feliz', '19'),
...
('300', 'Tú volverás', 'Sergio & Estíbaliz', '47', '', 'Sergio & Estíbaliz represented Spain in 1975 with the song Tú volverás', '20'),
...
('325', 'Sobran las palabras', 'Braulio', '47', '', 'Braulio represented Spain in 1976 with the song Sobran las palabras', '21'),
...
('336', 'Enséñame a cantar', 'Micky', '47', '', 'Micky represented Spain in 1977 with the song Enséñame a cantar', '22'),
...
('354', 'Bailemos un vals', 'José Vélez', '47', '', 'José Vélez represented Spain in 1978 with the song Bailemos un vals', '23'),
...
-- Canciones del año 1979
INSERT INTO songs (id, title, artist, country_id, image, information, edition_id) VALUES
('366', 'Hallelujah', 'Milk and Honey', '24', '', 'Milk and Honey represented Israel in 1979 with the song Hallelujah', '24'),
('367', 'Su canción', 'Betty Missiego', '47', '', 'Betty Missiego represented Spain in 1979 with the song Su canción', '24'),
...
('396', 'Quédate esta noche', 'Trigo Limpio', '47', '', 'Trigo Limpio represented Spain in 1980 with the song Quédate esta noche', '25'),
...
('417', 'Y sólo tú', 'Bacchelli', '47', '', 'Bacchelli represented Spain in 1981 with the song Y sólo tú', '26'),
...
('433', 'Él', 'Lucía', '47', '', 'Lucía represented Spain in 1982 with the song Él', '27'),
...
('461', '¿Quién maneja mi barca?', 'Remedios Amaya', '47', '', 'Remedios Amaya represented Spain in 1983 with the song ¿Quién maneja mi barca?', '28');

-- Canciones del año 1984
INSERT INTO songs (id, title, artist, country_id, image, information, edition_id) VALUES
...
('464', 'Lady, Lady', 'Bravo', '47', '', 'Bravo represented Spain in 1984 with the song Lady, Lady', '29'),
...
('494', 'La fiesta terminó', 'Paloma San Basilio', '47', '', 'Paloma San Basilio represented Spain in 1985 with the song La fiesta terminó', '30'),
...
('509', 'Valentino', 'Cadillac', '47', '', 'Cadillac represented Spain in 1986 with the song Valentino', '31'),
...
('538', 'No estás solo', 'Patricia Kraus', '47', '', 'Patricia Kraus represented Spain in 1987 with the song No estás solo', '32'),
...
('552', 'La chica que yo quiero (Made in Spain)', 'La Década', '47', '', 'La Década represented Spain in 1988 with the song La chica que yo quiero (Made in Spain)', '33'),
...
('568', 'Nacida para amar', 'Nina', '47', '', 'Nina represented Spain in 1989 with the song Nacida para amar', '34'),
...
('589', 'Bandido', 'Azúcar Moreno', '47', '', 'Azúcar Moreno represented Spain in 1990 with the song Bandido', '35'),
...
('610', 'Bailar Pegados', 'Sergio Dalma', '47', '', 'Sergio Dalma represented Spain in 1991 with the song Bailar Pegados', '36'),
...
('642', 'Todo Esto Es La Música', 'Serafin', '47', '', 'Serafin represented Spain in 1992 with the song Todo Esto Es La Música', '37'),
...
('662', 'Hombres', 'Eva Santamaria', '47', '', 'Eva Santamaria represented Spain in 1993 with the song Hombres', '38'),
...
('694', 'Ella No Es Ella', 'Alejandro Abad', '47', '', 'Alejandro Abad represented Spain in 1994 with the song Ella No Es Ella', '39'),
...
-- Canciones del año 1995
INSERT INTO songs (id, title, artist, country_id, image, information, edition_id) VALUES
('702', 'Nocturne', 'Secret Garden', '37', '', 'Secret Garden represented Norway in 1995 with the song Nocturne', '40'),
('703', 'Vuelve Conmigo', 'Anabel Conde', '47', '', 'Anabel Conde represented Spain in 1995 with the song Vuelve Conmigo', '40'),
...
('744', '¡Ay, Qué Deseo!', 'Antonio Carbonell', '47', '', 'Antonio Carbonell represented Spain in 1996 with the song ¡Ay, Qué Deseo!', '41'),
...
('753', 'Sin Rencor', 'Marcos Llunas', '47', '', 'Marcos Llunas represented Spain in 1997 with the song Sin Rencor', '42'),
...
('788', '¿Qué Voy A Hacer Sin Ti?', 'Mikel Herzog', '47', '', 'Mikel Herzog represented Spain in 1998 with the song ¿Qué Voy A Hacer Sin Ti?', '43'),
...
('820', 'No Quiero Escuchar', 'Lydia', '47', '', 'Lydia represented Spain in 1999 with the song No Quiero Escuchar', '44');

-- Canciones del año 2000
INSERT INTO songs (id, title, artist, country_id, image, information, edition_id) VALUES
...
('838', 'Colgado De Un Sueño', 'Serafín Zubiri', '47', '', 'Serafín Zubiri represented Spain in 2000 with the song Colgado De Un Sueño', '45'),
...
('850', 'Dile Que La Quiero', 'David Civera', '47', '', 'David Civera represented Spain in 2001 with the song Dile Que La Quiero', '46'),
...
('874', 'Europe''s Living A Celebration', 'Rosa', '47', '', 'Rosa represented Spain in 2002 with the song Europe''s Living A Celebration', '47'),
...
('900', 'Dime', 'Beth', '47', '', 'Beth represented Spain in 2003 with the song Dime', '48'),
...
('927', 'Para Llenarme De Ti', 'Ramón', '47', '', 'Ramón represented Spain in 2004 with the song Para Llenarme De Ti', '49'),
...
('974', 'Brujería', 'Son de sol', '47', '', 'Son de sol represented Spain in 2005 with the song Brujería', '50'),
...
('1013', 'Bloody Mary', 'Las Ketchup', '47', '', 'Las Ketchup represented Spain in 2006 with the song Bloody Mary', '51'),
...
('1049', 'I Love You Mi Vida', 'D''Nash', '47', '', 'D''Nash represented Spain in 2007 with the song I Love You Mi Vida', '52'),
...
('1087', 'Baila El Chiki Chiki', 'Rodolfo Chikilicuatre', '47', '', 'Rodolfo Chikilicuatre represented Spain in 2008 with the song Baila El Chiki Chiki', '53'),
...
('1138', 'La Noche Es Para Mí', 'Soraya', '47', '', 'Soraya represented Spain in 2009 with the song La Noche Es Para Mí', '54'),
...
('1171', 'Algo Pequeñito', 'Daniel Diges', '47', '', 'Daniel Diges represented Spain in 2010 with the song Algo Pequeñito', '55'),
...
('1218', 'Que Me Quiten Lo Bailao', 'Lucía Pérez', '47', '', 'Lucía Pérez represented Spain in 2011 with the song Que Me Quiten Lo Bailao', '56'),
...
('1248', 'Quédate Conmigo', 'Pastora Soler', '47', '', 'Pastora Soler represented Spain in 2012 with the song Quédate Conmigo', '57'),
...
('1305', 'Contigo Hasta El Final', 'ESDM', '47', '', 'ESDM represented Spain in 2013 with the song Contigo Hasta El Final', '58'),
...
('1329', 'Dancing in the rain', 'Ruth Lorenzo', '47', '', 'Ruth Lorenzo represented Spain in 2014 with the song Dancing in the rain', '59'),
...
('1377', 'Amanecer', 'Edurne', '47', '', 'Edurne represented Spain in 2015 with the song Amanecer', '60'),
...
('1418', 'Say Yay!', 'Barei', '47', '', 'Barei represented Spain in 2016 with the song Say Yay!', '61'),
...
('1464', 'Do It for Your Lover', 'Manel Navarro', '47', '', 'Manel Navarro represented Spain in 2017 with the song Do It for Your Lover', '62'),
...
('1503', 'Tu Canción', 'Amaia & Alfred', '47', '', 'Amaia & Alfred represented Spain in 2018 with the song Tu Canción', '63'),
...
('1545', 'La Venda', 'Miki', '47', '', 'Miki represented Spain in 2019 with the song La Venda', '64'),
...
('1601', 'Universo', 'Blas Cantó', '47', '', 'Blas Cantó represented Spain in 2020 with the song Universo', '65'),
...
('1629', 'Voy A Quedarme', 'Blas Cantó', '47', '', 'Blas Cantó represented Spain in 2021 with the song Voy A Quedarme', '66'),
...
('1647', 'SloMo', 'Chanel', '47', '', 'Chanel represented Spain in 2022 with the song SloMo', '67'),
...
('1701', 'Eaea', 'Blanca Paloma', '47', '', 'Blanca Paloma represented Spain in 2023 with the song Eaea', '68'),
...
('1743', 'Zorra', 'Nebulossa', '47', '', 'Nebulossa represented Spain in 2024 with the song Zorra', '69'),
